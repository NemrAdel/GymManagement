        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneConstraint1", "[Phone] like '01[0125]________'");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("PhoneConstraint", "[Phone] like '01[0125]________'");
                    table.ForeignKey(
                        name: "FK_Members_HealthRecords_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsIttended = table.Column<bool>(type: "bit", nullable: false),
